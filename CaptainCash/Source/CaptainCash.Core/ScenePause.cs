...
{
	public class ScenePause : AbstractScene
	{
		public ScenePause (Game game, GraphicsDevice graphicsDevice) : base (game, graphicsDevice, "ScenePause", 800, 480)
		{
		}
			
		public override void LoadContent ()
		{
			System.Console.Out.WriteLine("ScenePause" + " LoadContent()");
		}
