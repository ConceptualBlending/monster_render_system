	...
	public class Game1 : Game
	{
		...
		void setupGamePadKeyboard ()
		{
			GamePadButtonsKeyBinding gamePadButtonsKeyBinding = new GamePadButtonsKeyBinding ()
			{
				...
				keyBack = Keys.C,
				keyBigButton = Keys.D,
				keyBumberLeft = Keys.E,
				keyTriggerLeft = Keys.F,
				keyBumberRight = Keys.G,
				keyTriggerRight = Keys.H,
				keyStart = Keys.I,
				keyX = Keys.X,
				keyY = Keys.Y
			};
		...
		protected override void Update (GameTime gameTime)
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				//var caps = OpenTK.Input.GamePad.GetState (0).IsConnected;
				//if (caps.HasAButton)
				//	; // do something
		...
		protected override void Draw (GameTime gameTime)
		{
			...
			//System.Console.WriteLine (GamePad.GetCapabilities (PlayerIndex.One).GamePadType);
			//System.Console.WriteLine (GamePad.GetState (PlayerIndex.One).IsConnected);
//
